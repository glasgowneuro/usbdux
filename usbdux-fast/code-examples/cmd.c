...
/*
 * The program is used to test the usbdux fast board. It samples on all
 * 16 channels at a rate of 60kHz.
 */
...
int prepare_cmd_lib(comedi_t *dev, int subdevice, int n_scan, int n_chan, unsigned scan_period_nanosec, comedi_cmd *cmd)
{
	 ...
	 * that's bad. */
	comedi_get_cmd_generic_timed(dev, subdevice, cmd, n_chan, scan_period_nanosec);
